...
namespace LyncBillingTesting
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // List<Announcement> ann = _STORAGE.Announcements.GetAll().ToList<Announcement>();
            //List<User> users = _STORAGE.Users.GetAll().ToList();

            List<PhoneCall> x = _STORAGE.PhoneCalls.GetChargeableCallsForSite("MOA").ToList<PhoneCall>();
